    ...
    module Simple
      ...
      class Client
        ...
        def connect(url, options={})
          ...
          @socket.setsockopt(Socket::SOL_SOCKET, Socket::TCP_KEEPIDLE, 20)
          @socket.setsockopt(Socket::SOL_SOCKET, Socket::TCP_KEEPINTVL, 3)
          @socket.setsockopt(Socket::SOL_SOCKET, Socket::TCP_KEEPCNT, 5)          
